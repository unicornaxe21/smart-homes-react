  ...
  return (
    ...
    <div className='tp-header'>
        ...
        <div className='tp-header-right'>
            <Link to=""><i class="fas fa-star"></i></Link>
            ...
            <div className='row'>
                ...
                <div className='col-lg-5'>
                    <div className='property-dtl-fltr-rgt'>
                        <Link  to="/add-house"><i class="fas fa-plus me-2"></i>Add House</Link>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div className='container-fluid'>
            <div className='row'>
                <div className='col-lg-7'>
                    <div className='property-dtl-lst-lft'>
                        <div className='property-dtl-lst-lft-icon'>
                            ...
                            <Link><i class="fas fa-chevron-left"></i></Link>
                ...
                <div className='col-lg-5'>
                    ...
                    <Link to="" className="shadowb-btn">Continue</Link>
                    </div>
                </div>
            </div>
        </div>
