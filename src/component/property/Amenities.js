      ...
      <ul className='mb-0'>
         ...
         <li className='navitem'>
            <div className="dropdown">
               <button className="dropdown-toggle" type="button" id="dropdown" data-bs-toggle="dropdown" aria-expanded="false">Floors</button>
               <ul className="dropdown-menu" aria-labelledby="dropdown">
                  <li>
                     <Link className="dropdown-item" to="">Floor 1</Link>
                  </li>
                  <li>
                     <Link className="dropdown-item" to="">Floor 2</Link>
                  </li>
                  <li>
                     <Link className="dropdown-item" to="">Floor 3</Link>
                  </li>
               </ul>
            </div>
         </li>
        ...
        <div className='row'>
            <div className='col-lg-3 col-md-6 col-sm-6'>
                <div className='amenities-card amenities-flor'>
                    <h4 className='text-center'><span>Flats / Houses</span></h4>
                    <h5 className='text-end mb-4'><button><i class="fas fa-chevron-left"></i></button><span>Floors</span><button><i class="fas fa-chevron-right"></i></button></h5>
                ...
                <div className='amenities-card amenities-hall'>
                    ...
                    Bed Room
                    <Link to="" class="text-dark"><i class="far fa-plus"></i></Link></h4>
                    <h6>Favourite's</h6>
                    <ul className='amenities-lst'>
                    <li>
                            <button className='on'>
